...
public class Korean extends Language {
  ...
  public Contributor[] getMaintainers() {
    return new Contributor[] { new Contributor("Jeonghan Choe")};
  }
...
//  @Override
//  public List<Rule> getRelevant  Rules(ResourceBundle messages, UserConfig userConfig, Language motherTongue, List<Language> altLanguages) {
